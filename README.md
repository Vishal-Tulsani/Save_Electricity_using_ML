...
Built using [openCV](http://opencv.net/)'s state-of-the-art camera
built with machine learning. 

This also provides a simple `Save_Electricity` command line tool that lets
you do save electricity on a folder of live from the command line!
