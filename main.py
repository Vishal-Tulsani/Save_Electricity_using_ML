...
import re
import hashlib
import detect_bright_spots 

app = Flask(__name__)

# Change this to your secret key (can be anything, it's for extra protection)
app.secret_key = '8caa30a6fb56f2bb3feafffa61815f89a367'

# Enter your database connection details below
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'root'
app.config['MYSQL_PASSWORD'] = 'monu1010'
...
def register():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form and 'email' in request.form:
        ...
        if account:
            ...
            cursor.execute('INSERT INTO accounts VALUES (NULL, %s, %s, %s, %s)', (username, password, email, mobile))
...
@app.route('/pythonlogin/camera')
def bright():
    # Check if user is loggedin
    if 'loggedin' in session:
        # User is loggedin show them the home page
        detect_bright_spots.camera()
